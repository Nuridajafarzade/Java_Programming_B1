...
public class B extends A {
    ...
    // The one below is just a new static method that
    // belongs to the CHILD clas. If the Child class name
    // is sued to call this method, the one in the Parent class will be hidded.
