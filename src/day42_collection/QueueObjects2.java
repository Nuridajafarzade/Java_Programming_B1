...
public class QueueObjects2 {
    public static void main(String[] args) {
        ...
        /*
        1- the poll() method will remove it from the beginning
        2-Oce it is removed, it will keep the insertion order to the ArrayDeque.

        If you have another poll() methods, then it will remove it the first one again , the step 2 will happen again
         */
