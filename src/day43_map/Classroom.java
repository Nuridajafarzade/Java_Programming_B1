...
public class Classroom {
    public static void main(String[] args) {
      /*
        ...
        map.put(3,new Student("Nur",3.95,10));
        map.put(4,new Student("Gul",3.90,11));;
        map.put(5,new Student("Gulyanaq",4.00,13));
        System.out.println(map);
        System.out.println("-----------");
        System.out.println(map.get(3));
        System.out.println("------------");

        //How  can I get Only the name of 4th element in the map
